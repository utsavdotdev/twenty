...
export type UpdatePlatformRequestBody = Static<
  typeof UpdatePlatformRequestBody
>;
...
export type AdminAddPlatformRequestBody = Static<
  typeof AdminAddPlatformRequestBody
>;
