...
export type ValidateConnectionNameResponse = Static<
  typeof ValidateConnectionNameResponse
>;
...
export type ValidateConnectionNameRequestBody = Static<
  typeof ValidateConnectionNameRequestBody
>;
